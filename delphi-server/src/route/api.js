...
apiRouter.post('/set-random-result', (req, res, next) => {
  DelphiOracle.setRandomResult(req.params)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
apiRouter.post('/oracle', (req, res, next) => {
  DelphiOracle.oracle(req.params)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
apiRouter.post('/bet-start-block', (req, res, next) => {
  DelphiOracle.bettingStartBlock(req.params)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
apiRouter.post('/bet-end-block', (req, res, next) => {
  DelphiOracle.bettingEndBlock(req.params)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
apiRouter.post('/result-set-start-block', (req, res, next) => {
  DelphiOracle.resultSettingStartBlock(req.params)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
apiRouter.post('/result-set-end-block', (req, res, next) => {
  DelphiOracle.resultSettingEndBlock(req.params)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
